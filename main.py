...
LiveCapIcon = PhotoImage(file = r"./images/videocap.png")
imageIcon = PhotoImage(file = r"./images/imageicon.png")
...
def imageProcessing(filepath,isCapturing):
    faceProto = "./trained_models/opencv_face_detector.pbtxt"
    faceModel = "./trained_models/opencv_face_detector_uint8.pb"
    ageProto = "./trained_models/age_deploy.prototxt"
    ageModel = "./trained_models/age_net.caffemodel"
    genderProto = "./trained_models/gender_deploy.prototxt"
    genderModel = "./trained_models/gender_net.caffemodel"
